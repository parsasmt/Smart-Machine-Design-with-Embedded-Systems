...
/*
 * File: IR_sensor_tinkercad.h
 *
 * Code generated for Simulink model 'IR_sensor_tinkercad'.
 *
 * Model version                  : 1.3
 * Simulink Coder version         : 9.7 (R2022a) 13-Nov-2021
 * C/C++ source code generated on : Thu Jul  4 14:16:56 2024
 *
...
#ifndef RTW_HEADER_IR_sensor_tinkercad_h_
#define RTW_HEADER_IR_sensor_tinkercad_h_
#ifndef IR_sensor_tinkercad_COMMON_INCLUDES_
#define IR_sensor_tinkercad_COMMON_INCLUDES_
//#include "rtwtypes.h"
//#include "rtw_continuous.h"
//#include "rtw_solver.h"
#endif                                /* IR_sensor_tinkercad_COMMON_INCLUDES_ */

/*
 * File: IR_sensor_tinkercad_types.h
 *
 * Code generated for Simulink model 'IR_sensor_tinkercad'.
 *
 * Model version                  : 1.3
...
#ifndef RTW_HEADER_IR_sensor_tinkercad_types_h_
#define RTW_HEADER_IR_sensor_tinkercad_types_h_

/* Model Code Variants */

/* Forward declaration for rtModel */
typedef struct tag_RTM_IR_sensor_tinkercad_T RT_MODEL_IR_sensor_tinkercad_T;

#endif                             /* RTW_HEADER_IR_sensor_tinkercad_types_h_ */
...
typedef struct {
  real_T accelator;                    /* '<Root>/Move Process' */
  uint8_T is_active_c1_IR_sensor_tinkerca;/* '<Root>/Move Process' */
  uint8_T is_c1_IR_sensor_tinkercad;   /* '<Root>/Move Process' */
} DW_IR_sensor_tinkercad_T;

/* External inputs (root inport signals with default storage) */
typedef struct {
  real_T IR_input;                     /* '<Root>/IR_input' */
  real_T car_move;                     /* '<Root>/car_move' */
} ExtU_IR_sensor_tinkercad_T;

/* External outputs (root outports fed by signals with default storage) */
typedef struct {
  real_T Car_x_postion;                /* '<Root>/Car_x_postion' */
  real_T Car_y_postion;                /* '<Root>/Car_y_postion' */
} ExtY_IR_sensor_tinkercad_T;

/* Real-time Model Data Structure */
struct tag_RTM_IR_sensor_tinkercad_T {
  const char_T * volatile errorStatus;
};

/* Block states (default storage) */
extern DW_IR_sensor_tinkercad_T IR_sensor_tinkercad_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_IR_sensor_tinkercad_T IR_sensor_tinkercad_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_IR_sensor_tinkercad_T IR_sensor_tinkercad_Y;

/* Model entry point functions */
extern void IR_sensor_tinkercad_initialize(void);
extern void IR_sensor_tinkercad_step(void);
extern void IR_sensor_tinkercad_terminate(void);

/* Real-time Model object */
extern RT_MODEL_IR_sensor_tinkercad_T *const IR_sensor_tinkercad_M;
 ...
 *
 * '<Root>' : 'IR_sensor_tinkercad'
 * '<S1>'   : 'IR_sensor_tinkercad/Move Process'
 */
#endif                                 /* RTW_HEADER_IR_sensor_tinkercad_h_ */
...
#define IR_sensor_tin_IN_straight_right ((uint8_T)5U)
#define IR_sensor_tink_IN_straight_down ((uint8_T)3U)
#define IR_sensor_tink_IN_straight_left ((uint8_T)4U)
#define IR_sensor_tinker_IN_straight_up ((uint8_T)6U)
#define IR_sensor_tinkerc_IN_Start_move ((uint8_T)1U)
#define IR_sensor_tinkercad_IN_Stop_car ((uint8_T)2U)

/* Block states (default storage) */
DW_IR_sensor_tinkercad_T IR_sensor_tinkercad_DW;

/* External inputs (root inport signals with default storage) */
ExtU_IR_sensor_tinkercad_T IR_sensor_tinkercad_U;

/* External outputs (root outports fed by signals with default storage) */
ExtY_IR_sensor_tinkercad_T IR_sensor_tinkercad_Y;

/* Real-time model */
static RT_MODEL_IR_sensor_tinkercad_T IR_sensor_tinkercad_M_;
RT_MODEL_IR_sensor_tinkercad_T *const IR_sensor_tinkercad_M =
  &IR_sensor_tinkercad_M_;

/* Model step function */
void IR_sensor_tinkercad_step(void)
{
  /* Chart: '<Root>/Move Process' incorporates:
   *  Inport: '<Root>/IR_input'
   *  Inport: '<Root>/car_move'
   */
  if (IR_sensor_tinkercad_DW.is_active_c1_IR_sensor_tinkerca == 0U) {
    IR_sensor_tinkercad_DW.is_active_c1_IR_sensor_tinkerca = 1U;

    /* Outport: '<Root>/Car_x_postion' */
    IR_sensor_tinkercad_Y.Car_x_postion = 0.0;

    /* Outport: '<Root>/Car_y_postion' */
    IR_sensor_tinkercad_Y.Car_y_postion = 0.0;
    IR_sensor_tinkercad_DW.accelator = 5.0;
    IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
      IR_sensor_tinkercad_IN_Stop_car;
  } else {
    switch (IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad) {
     case IR_sensor_tinkerc_IN_Start_move:
      if (IR_sensor_tinkercad_U.car_move == 0.0) {
        IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
          IR_sensor_tinkercad_IN_Stop_car;
      } else if (IR_sensor_tinkercad_U.IR_input == 17.0) {
        /* Outport: '<Root>/Car_y_postion' */
        IR_sensor_tinkercad_Y.Car_y_postion += IR_sensor_tinkercad_DW.accelator;
        IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
          IR_sensor_tinker_IN_straight_up;
      } else if (IR_sensor_tinkercad_U.IR_input == 25.0) {
        /* Outport: '<Root>/Car_y_postion' */
        IR_sensor_tinkercad_Y.Car_y_postion -= IR_sensor_tinkercad_DW.accelator;
        IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
          IR_sensor_tink_IN_straight_down;
      } else if (IR_sensor_tinkercad_U.IR_input == 20.0) {
        /* Outport: '<Root>/Car_x_postion' */
        IR_sensor_tinkercad_Y.Car_x_postion -= IR_sensor_tinkercad_DW.accelator;
        IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
          IR_sensor_tink_IN_straight_left;
      } else if (IR_sensor_tinkercad_U.IR_input == 22.0) {
        /* Outport: '<Root>/Car_x_postion' */
        IR_sensor_tinkercad_Y.Car_x_postion += IR_sensor_tinkercad_DW.accelator;
        IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
          IR_sensor_tin_IN_straight_right;
      }
      break;

     case IR_sensor_tinkercad_IN_Stop_car:
      if (IR_sensor_tinkercad_U.car_move == 1.0) {
        IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
          IR_sensor_tinkerc_IN_Start_move;
      }
      break;

     case IR_sensor_tink_IN_straight_down:
      if (IR_sensor_tinkercad_U.IR_input != 25.0) {
        IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
          IR_sensor_tinkerc_IN_Start_move;
      } else if (IR_sensor_tinkercad_U.IR_input == 25.0) {
        /* Outport: '<Root>/Car_y_postion' */
     ...
     case IR_sensor_tink_IN_straight_left:
      if (IR_sensor_tinkercad_U.IR_input != 20.0) {
        IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
          IR_sensor_tinkerc_IN_Start_move;
      } else if (IR_sensor_tinkercad_U.IR_input == 20.0) {
        /* Outport: '<Root>/Car_x_postion' */
     ...
     case IR_sensor_tin_IN_straight_right:
      if (IR_sensor_tinkercad_U.IR_input != 22.0) {
        IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
          IR_sensor_tinkerc_IN_Start_move;
      } else if (IR_sensor_tinkercad_U.IR_input == 22.0) {
        /* Outport: '<Root>/Car_x_postion' */
     ...
     default:
      /* case IN_straight_up: */
      if (IR_sensor_tinkercad_U.IR_input != 17.0) {
        IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad =
          IR_sensor_tinkerc_IN_Start_move;
      } else if (IR_sensor_tinkercad_U.IR_input == 17.0) {
        /* Outport: '<Root>/Car_y_postion' */
...
void IR_sensor_tinkercad_initialize(void)
{
  /* (no initialization code required) */
}

/* Model terminate function */
void IR_sensor_tinkercad_terminate(void)
{
...
void t1(void){
    TEST_ASSERT_EQUAL(IR_sensor_tinkercad_IN_Stop_car, IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad);
}

void t2(void){
    TEST_ASSERT_EQUAL(IR_sensor_tinkerc_IN_Start_move, IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad);
}

void t3(void){
    TEST_ASSERT_EQUAL(IR_sensor_tinker_IN_straight_up, IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad);
}

void t4(void){
    TEST_ASSERT_EQUAL(IR_sensor_tink_IN_straight_down, IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad);
}

void t5(void){
    TEST_ASSERT_EQUAL(IR_sensor_tink_IN_straight_left, IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad);
}

void t6(void){
    TEST_ASSERT_EQUAL(IR_sensor_tin_IN_straight_right, IR_sensor_tinkercad_DW.is_c1_IR_sensor_tinkercad);
}
...
int main(){
    ...
    IR_sensor_tinkercad_step();
    RUN_TEST(t1);

    IR_sensor_tinkercad_U.car_move = 1.0;
    IR_sensor_tinkercad_step();
    RUN_TEST(t2);

    IR_sensor_tinkercad_U.car_move = 0.0;
    IR_sensor_tinkercad_step();
    RUN_TEST(t1);
    ...
    IR_sensor_tinkercad_U.IR_input = 17.0;
    IR_sensor_tinkercad_step();
    RUN_TEST(t3);
    ...
    IR_sensor_tinkercad_U.IR_input = 0.0;
    IR_sensor_tinkercad_step();
    RUN_TEST(t2);

    IR_sensor_tinkercad_U.IR_input = 25.0;
    IR_sensor_tinkercad_step();
    RUN_TEST(t4);
    ...
    IR_sensor_tinkercad_U.IR_input = 20.0;
    IR_sensor_tinkercad_step();
    RUN_TEST(t5);
    ...
    IR_sensor_tinkercad_U.IR_input = 22.0;
    IR_sensor_tinkercad_step();
    RUN_TEST(t6);
