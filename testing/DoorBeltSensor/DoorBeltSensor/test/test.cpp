...
/*
 * File: door_belt_alarm.h
 *
 * Code generated for Simulink model 'door_belt_alarm'.
 *
 * Model version                  : 1.1
 * Simulink Coder version         : 9.7 (R2022a) 13-Nov-2021
 * C/C++ source code generated on : Thu Jul  4 17:42:07 2024
 *
...
#ifndef RTW_HEADER_door_belt_alarm_h_
#define RTW_HEADER_door_belt_alarm_h_
#ifndef door_belt_alarm_COMMON_INCLUDES_
#define door_belt_alarm_COMMON_INCLUDES_
// #include "rtwtypes.h"
// #include "rtw_continuous.h"
// #include "rtw_solver.h"
#endif                                 /* door_belt_alarm_COMMON_INCLUDES_ */

/*
 * File: door_belt_alarm_types.h
 *
 * Code generated for Simulink model 'door_belt_alarm'.
 *
 * Model version                  : 1.1
...
#ifndef RTW_HEADER_door_belt_alarm_types_h_
#define RTW_HEADER_door_belt_alarm_types_h_

/* Model Code Variants */

/* Forward declaration for rtModel */
typedef struct tag_RTM_door_belt_alarm_T RT_MODEL_door_belt_alarm_T;

#endif                                 /* RTW_HEADER_door_belt_alarm_types_h_ */
...
typedef struct {
  uint8_T is_active_c2_door_belt_alarm;/* '<Root>/DOOR & Belt Alert' */
  uint8_T is_c2_door_belt_alarm;       /* '<Root>/DOOR & Belt Alert' */
} DW_door_belt_alarm_T;
...
} ExtU_door_belt_alarm_T;

/* External outputs (root outports fed by signals with default storage) */
typedef struct {
  real_T belt_alarm;                   /* '<Root>/belt_alarm' */
  real_T door_alarm;                   /* '<Root>/door_alarm' */
} ExtY_door_belt_alarm_T;

/* Real-time Model Data Structure */
struct tag_RTM_door_belt_alarm_T {
  const char_T * volatile errorStatus;
};

/* Block states (default storage) */
extern DW_door_belt_alarm_T door_belt_alarm_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_door_belt_alarm_T door_belt_alarm_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_door_belt_alarm_T door_belt_alarm_Y;

/* Model entry point functions */
extern void door_belt_alarm_initialize(void);
extern void door_belt_alarm_step(void);
extern void door_belt_alarm_terminate(void);

/* Real-time Model object */
extern RT_MODEL_door_belt_alarm_T *const door_belt_alarm_M;
 ...
 *
 * '<Root>' : 'door_belt_alarm'
 * '<S1>'   : 'door_belt_alarm/DOOR & Belt Alert'
 */
#endif                                 /* RTW_HEADER_door_belt_alarm_h_ */
...
#define door_belt_alarm_IN_b_alarm_off ((uint8_T)1U)
#define door_belt_alarm_IN_b_alarm_on  ((uint8_T)2U)
#define door_belt_alarm_IN_d_alarm_off ((uint8_T)3U)
#define door_belt_alarm_IN_d_alarm_on  ((uint8_T)4U)
#define door_belt_alarm_IN_idel        ((uint8_T)5U)

/* Block states (default storage) */
DW_door_belt_alarm_T door_belt_alarm_DW;

/* External inputs (root inport signals with default storage) */
ExtU_door_belt_alarm_T door_belt_alarm_U;

/* External outputs (root outports fed by signals with default storage) */
ExtY_door_belt_alarm_T door_belt_alarm_Y;

/* Real-time model */
static RT_MODEL_door_belt_alarm_T door_belt_alarm_M_;
RT_MODEL_door_belt_alarm_T *const door_belt_alarm_M = &door_belt_alarm_M_;

/* Model step function */
void door_belt_alarm_step(void)
{
   ...
   */
  if (door_belt_alarm_DW.is_active_c2_door_belt_alarm == 0U) {
    door_belt_alarm_DW.is_active_c2_door_belt_alarm = 1U;

    /* Outport: '<Root>/door_alarm' */
    door_belt_alarm_Y.door_alarm = 0.0;

    /* Outport: '<Root>/belt_alarm' */
    door_belt_alarm_Y.belt_alarm = 0.0;
    door_belt_alarm_DW.is_c2_door_belt_alarm = door_belt_alarm_IN_idel;
  } else {
    switch (door_belt_alarm_DW.is_c2_door_belt_alarm) {
     case door_belt_alarm_IN_b_alarm_off:
      door_belt_alarm_DW.is_c2_door_belt_alarm = door_belt_alarm_IN_idel;
      break;

     case door_belt_alarm_IN_b_alarm_on:
      door_belt_alarm_DW.is_c2_door_belt_alarm = door_belt_alarm_IN_idel;
      break;

     case door_belt_alarm_IN_d_alarm_off:
      door_belt_alarm_DW.is_c2_door_belt_alarm = door_belt_alarm_IN_idel;
      break;

     case door_belt_alarm_IN_d_alarm_on:
      door_belt_alarm_DW.is_c2_door_belt_alarm = door_belt_alarm_IN_idel;
      break;

     default:
      /* case IN_idel: */
      if ((door_belt_alarm_U.MoveSensor == 1.0) &&
          (door_belt_alarm_U.Belt_sensor == 0.0) &&
          (door_belt_alarm_Y.belt_alarm == 0.0)) {
        door_belt_alarm_Y.belt_alarm = 1.0;
        door_belt_alarm_DW.is_c2_door_belt_alarm = door_belt_alarm_IN_b_alarm_on;
      } else if (((door_belt_alarm_U.Belt_sensor == 1.0) &&
                  (door_belt_alarm_Y.belt_alarm == 1.0)) ||
                 ((door_belt_alarm_U.MoveSensor == 0.0) &&
                  (door_belt_alarm_Y.belt_alarm == 1.0))) {
        door_belt_alarm_Y.belt_alarm = 0.0;
        door_belt_alarm_DW.is_c2_door_belt_alarm =
          door_belt_alarm_IN_b_alarm_off;
      } else if ((door_belt_alarm_U.Door_sensor == 1.0) &&
                 (door_belt_alarm_Y.door_alarm == 0.0)) {
        /* Outport: '<Root>/door_alarm' */
        door_belt_alarm_Y.door_alarm = 1.0;
        door_belt_alarm_DW.is_c2_door_belt_alarm = door_belt_alarm_IN_d_alarm_on;
      } else if ((door_belt_alarm_U.Door_sensor == 0.0) &&
                 (door_belt_alarm_Y.door_alarm == 1.0)) {
        /* Outport: '<Root>/door_alarm' */
        door_belt_alarm_Y.door_alarm = 0.0;
        door_belt_alarm_DW.is_c2_door_belt_alarm =
          door_belt_alarm_IN_d_alarm_off;
      }
      break;
    }
  }
...
void door_belt_alarm_initialize(void)
{
  /* (no initialization code required) */
}

/* Model terminate function */
void door_belt_alarm_terminate(void)
{
...
void t1(void){
    TEST_ASSERT_EQUAL(door_belt_alarm_IN_idel, door_belt_alarm_DW.is_c2_door_belt_alarm);
}

void t2(void){
    TEST_ASSERT_EQUAL(door_belt_alarm_IN_b_alarm_on, door_belt_alarm_DW.is_c2_door_belt_alarm);
}

void t3(void){
    TEST_ASSERT_EQUAL(door_belt_alarm_IN_b_alarm_off, door_belt_alarm_DW.is_c2_door_belt_alarm);
}

void t4(void){
    TEST_ASSERT_EQUAL(door_belt_alarm_IN_d_alarm_on, door_belt_alarm_DW.is_c2_door_belt_alarm);
}

void t5(void){
    TEST_ASSERT_EQUAL(door_belt_alarm_IN_d_alarm_off, door_belt_alarm_DW.is_c2_door_belt_alarm);
}
...
int main(){
    ...
    door_belt_alarm_step();
    RUN_TEST(t1);

    door_belt_alarm_U.MoveSensor = 1.0;
    door_belt_alarm_U.Belt_sensor = 0.0;
    door_belt_alarm_step();
    RUN_TEST(t2);
    ...
    door_belt_alarm_U.Belt_sensor = 1.0;
    door_belt_alarm_step();
    RUN_TEST(t3);
    ...
    door_belt_alarm_U.Door_sensor = 1.0;
    door_belt_alarm_step();
    RUN_TEST(t4);
    ...
    door_belt_alarm_U.Door_sensor = 0.0;
    door_belt_alarm_step();
    RUN_TEST(t5);
